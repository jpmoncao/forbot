...
function identifyMessage(message) {
    ...
    function redirectToCorrectMessage(msg) {
        ...
        if (['AJUDA', 'AJUDE', 'AJUDAR', 'AJUDA?', 'AJUDAME', 'AJUDA-ME', 'MEAJUDA', 'PRECISODEAJUDA', 'HELP', 'AJUDAR', 'AJUDAR?', 'AJUDARIA', 'AJUDARA', 'AJUDARÁ', 'AJUDEME', 'AJUDE-ME', 'MEAJUDE', 'PODEME AJUDAR', 'VOCEPODE ME AJUDAR', 'VOCÊPODE ME AJUDAR', 'OICOMO VOCÊ PODE ME AJUDAR', 'OLÁCOMO VOCÊ PODE ME AJUDAR', 'EMQUE VOCÊ PODE ME AJUDAR', 'PRECISODE AJUDA', 'EMQUE VOCÊ PODE SER ÚTIL', 'COMOVOCÊ PODE SER ÚTIL', 'INEED HELP', 'PLEASEHELP ME', 'PORFAVOR ME AJUDE', 'PORGENTILEZA VOCÊ PODE ME AJUDAR', 'PORFAVOR VOCÊ PODE ME AJUDAR', 'COMOPODE ME AJUDAR?', 'COMOPODE ME AJUDAR', 'OQUE VOCE FAZ', 'OQUE VOCE FAZ?'].includes(userMessage)) {
